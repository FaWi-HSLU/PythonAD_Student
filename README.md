...
| **Activate an environment**                | `conda activate <env_name>` <br> **Constraint:** <br> Usable anywhere <br>                                         | `source <env_name>/bin/activate` (Linux/Mac) <br> `<env_name>\Scripts\activate` (Windows) <br> **Constraint:** <br> Only usable in folder where `venv` is <br>| `pipenv shell` <br> **Constraint:** <br> Only usable in folder where `pipenv` is                                             |
