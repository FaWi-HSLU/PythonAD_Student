...
| **Activate an environment**                | **Constraint:** Usable anywhere `conda activate <env_name>` <br>                                         | **Constraint:** Only usable in folder where `venv` is <br> `source <env_name>/bin/activate` (Linux/Mac) <br> `<env_name>\Scripts\activate` (Windows) | **Constraint:** Only usable in folder where `pipenv` is <br> `pipenv shell`                                             |
