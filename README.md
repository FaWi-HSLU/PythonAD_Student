...
| **Activate an environment**                | **Constraint:** <br> Usable anywhere <br> `conda activate <env_name>` <br>                                         | **Constraint:** <br> Only usable in folder where `venv` is <br> `source <env_name>/bin/activate` (Linux/Mac) <br> `<env_name>\Scripts\activate` (Windows) | **Constraint:** <br> Only usable in folder where `pipenv` is <br> `pipenv shell`                                             |
